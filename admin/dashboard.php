...
<body id="texte" class=" bg-[#E8BCB9] text-[#E8BCB9] ">
    <header class=" body-font bg-[#451952] ">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <a href="../commun/connecter.php?prenom=<?php echo ($prenom); ?>&nom=<?php echo ($nom); ?>&age=<?php echo ($age); ?>&mail=<?php echo ($mail); ?>&id=<?php echo ($id); ?>&profilD=<?php echo$profil_id;?>" class="text-2xl mr-5 hover:scale-125">Retour</a>
            </nav>
            ...
            <div class="grid grid-cols-4 gap-4">
                <div class="text-[#E8BCB9] bg-[#451952] p-4 rounded-lg text-center">
                    ...
                    <p>
                        <?php
                        $id = $_GET['id']; 
                        $tickets = $bdd->prepare ("SELECT *,intervention.nom as T FROM intervention,urgence,users where urgences = valeur AND client_id = users.id ");
